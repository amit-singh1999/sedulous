...
<body>
    <div class="container my-3 shadow">
        ...
        <button style="font-size:15px" class="btn btn-info btn-sm" onClick="refreshPage()"><i class="fa fa-refresh"></i></button>
            <form action="finalPDF.php" method="POST" id="validation" enctype="multipart/form-data">
                <div class="d-flex align-items-center justify-content-center cormorant">
                    <img src="logo.png" alt="">
                    <!-- <div class=""> -->
                    <h1 style="color:green"> CONTRACT TRAVEL FINAL EXPENSE REPORT</h1>
                    <!-- </div> -->
                </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-12 mb-2">
                        ...
                        <div id="tableDiv">
                            ...
                            <table id="table" class="center">
                                ...
                                <tr class="default-row border border-black custom-row" data-type="number" data-id="9" data-name="data[1][NUMBER OF MILES]" data-function="true">
                                    ...
                                    <td class="border border-black" id="table_row_8" style="color: brown"><input type="text" readonly></td>
                                </tr>
                        ...
                        <div class="mt-3">
                            <table>
                                ...
                                <tr>
                                    <h6>TOTAL EXPENSES = <span id="demo"></span></h6>
                                </tr><br>
                                <tr>
                                    <div>
                                        <h6> Travel Advance Amount Received =<span style="position: absolute; margin-left: 10px; margin-top: 3px;"> $ </span> <input type="number" oninput="validateAmount(this)" id="allow" name="travelAmount" style="padding-left: 14px;"><span id="alertSpan" class="text-danger" style="display: none;"></span></h6>
                                    </div>
                                </tr><br>
                                </tr>
